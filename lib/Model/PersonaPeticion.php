...
class PersonaPeticion implements ModelInterface, ArrayAccess
{
    ...
    protected static $apihubTypes = [
        ...
        'estado_civil' => '\RccLightSimulacion\Client\Model\CatalogoEstadoCivil',
        'sexo' => '\RccLightSimulacion\Client\Model\CatalogoSexo',
        'clave_elector' => 'string',
        'numero_dependientes' => 'string',
        'fecha_defuncion' => 'string',
        'domicilio' => '\RccLightSimulacion\Client\Model\Domicilio'
    ];
