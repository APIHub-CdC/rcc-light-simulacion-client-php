...
namespace RccLightSimulacion\Client\Interceptor;
...
use \RccLightSimulacion\Client\Interceptor\KeyHandler;
use \RccLightSimulacion\Client\Interceptor\MyLogger;
use \RccLightSimulacion\Client\Model\Errors;
use \RccLightSimulacion\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\RccLightSimulacion\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \RccLightSimulacion\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \RccLightSimulacion\Client\Model\Errores(["errors" => [$error]]);
